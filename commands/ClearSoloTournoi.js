...
module.exports.run = async (bot, message, args, ops) => {
    ...
    joinChannel.send(`[LOG] CLEAR SOLO BY <@${message.author.id}>`);

    message.reply(`<@${message.author.id}> solo tournoi complete :white_check_mark:`).then(message => message.delete(5000));
